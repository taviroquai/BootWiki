!function($, wysi) {
	"use strict"
        ...
        var editorGalleryUrl = 'mod/gallery';
						...
						+ "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>"
							...
							+ "<div class='modal-body'>"
							  + "<input value='http://' class='bootstrap-wysihtml5-insert-image-url input-xlarge'>"
                                                          + "<div class='bootstrap-wysihtml5-insert-image-gallery'></div>"
							+ "</div>"
							+ "<div class='modal-footer'>"
							  + "<a href='#' class='btn' data-dismiss='modal'>Cancel</a>"
	...
	Wysihtml5.prototype = {
		...
		initInsertImage: function(toolbar) {
			...
			insertImageModal.on('shown', function() {
				urlInput.focus();
                                if (editorGalleryUrl !== undefined) {
                                    insertImageModal.find('.bootstrap-wysihtml5-insert-image-gallery').
                                        load(editorGalleryUrl, function() {
