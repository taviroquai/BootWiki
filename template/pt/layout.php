        ...
        <div id="navbar" class="navbar-collapse collapse">
          <p class="navbar-text pull-right">
              ...
              <?php if (!empty($this->logged_username)) : ?>
                  ...
                  <a href="<?=$this->logout_link->href?>" class="navbar-link">Sair</a>
              <?php else: ?>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-3 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="nav-header">Recentes...</li>
          ...
          <ul class="nav nav-sidebar">
            <li class="nav-header">Mais popular...</li>
          ...
          <ul class="nav nav-sidebar">
            <li class="nav-header">Não publicado...</li>
